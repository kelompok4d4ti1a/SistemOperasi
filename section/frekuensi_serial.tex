...
\section 2. Dubutuhkan jumlah kabel yang sedikit, bisa hanya menggunakan 3 kabel yaitu saluran Transmit Data, saluran Receive Data, dan saluran Ground (Konfigurasi Null Modem 
 ...
 UART atau Universal Asynchronous Receiver-Transmitter adalah perangkat keras komputer yang menerjemahkan antara bit data paralel dan bit serial. UART biasanya merupakan rangkaian terintegrasi yang digunakan untuk komunikasi serial pada komputer atau perangkat periferal port serial. UART sekarang termasuk dalam beberapa mikrokontroler (misalnya, PIC16F628).

\subsection {Komponen chip UART}
komponen chip UART yang khas adalah sebagai berikut 
Chip UART biasanya terdiri dari:
· Transmit / Terima buffer
· Mengirim / Menerima kontrol
· Buffer Data Bus
· Baca / Tulis Logika Penuh
· Modem Penuh
